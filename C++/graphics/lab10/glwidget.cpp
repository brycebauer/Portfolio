...
void GLWidget::animate() {
    ...
    mat4 fromMat = //glm::rotate(mat4(1.0f), from.z, vec3(0,0,1))*
                   glm::rotate(mat4(1.0f), from.y, vec3(0,1,0));
                   //glm::rotate(mat4(1.0f), from.x, vec3(1,0,0));

    mat4 toMat = glm::rotate(mat4(1.0f), to.z, vec3(0,0,1))*
                 glm::rotate(mat4(1.0f), to.y, vec3(0,1,0))*
                 glm::rotate(mat4(1.0f), to.x, vec3(1,0,0));
