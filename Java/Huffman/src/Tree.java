...
class Node
{
	public static int freq; // data item (key)
	public static char letter; // data item
...
class Tree
{
	public static Node root; // first node of tree
	// -------------------------------------------------------------
	...
	// -------------------------------------------------------------
	public void insert(char dd, int id)
	{
		Node newNode = new Node(dd, id); // make new node
